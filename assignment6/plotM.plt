...
set title "Analysis of Merge Sort"
...
plot "dataM.txt" using 1:2 with lines ls 1 title "Best case"
plot "dataM.txt" using 1:3 with lines ls 2 title "Worst case"
plot "dataM.txt" using 1:4 with lines ls 3 title "Avg case"

plot "dataM.txt" using 1:2 with lines ls 1 title "Best case",\
"dataM.txt" using 1:3 with lines ls 2 title "Worst case",\
"dataM.txt" using 1:4 with lines ls 3 title "Avg case"
