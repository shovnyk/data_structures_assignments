...
set title "Analysis of Selection Sort"
...
plot "dataS.txt" using 1:2 with lines ls 1 title "Best case"
plot "dataS.txt" using 1:3 with lines ls 2 title "Worst case"
plot "dataS.txt" using 1:4 with lines ls 3 title "Avg case"

plot "dataS.txt" using 1:2 with lines ls 1 title "Best case",\
"dataS.txt" using 1:3 with lines ls 2 title "Worst case",\
"dataS.txt" using 1:4 with lines ls 3 title "Avg case"
