...
set title "Analysis of Insertion Sort"
...
plot "dataI.txt" using 1:2 with lines ls 1 title "Best case"
plot "dataI.txt" using 1:3 with lines ls 2 title "Worst case"
plot "dataI.txt" using 1:4 with lines ls 3 title "Avg case"

plot "dataI.txt" using 1:2 with lines ls 1 title "Best case",\
"dataI.txt" using 1:3 with lines ls 2 title "Worst case",\
"dataI.txt" using 1:4 with lines ls 3 title "Avg case"
